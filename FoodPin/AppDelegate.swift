...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    enum QuickAction: String {
        ...
        case NewRestaurant = "New Restaurant"
        
        init?(fullIdentifier: String) {
            guard let shortcutIdenitifier = fullIdentifier.componentsSeparatedByString(".").last else {
                return nil
            }
    ...
    private func handleQuickAction(shortcutItem: UIApplicationShortcutItem) -> Bool {
        ...
        case .NewRestaurant:
            if let navController = tabBarController.viewControllers?[0] {
                ...
                restaurantTableViewController.performSegueWithIdentifier("addRestaurant", sender: restaurantTableViewController)
            } else {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        // avoid calling "performActionForShortcutItem" function twice when app is resumed but "didFinishLaunchingWithOptions" instantiated
        
        if let quickActionItem = launchOptions?[UIApplicationLaunchOptionsShortcutItemKey] as? UIApplicationShortcutItem {
            handleQuickAction(quickActionItem)
            
            return false
        }
        
        // Uncomment the following lines to use a custom indicator image in tabs
